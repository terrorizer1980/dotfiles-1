#+TITLE: My Emacs Configuration or: How I Learned to Stop Worrying and Love Spacemacs
...
layers configuration. The most noteworthy bit is the the font setting—Fira Code
at 14 px.
